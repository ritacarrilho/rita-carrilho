...
//textarea input
const textAreaInput = document.querySelector("#message-area");
// button 
const formButton = document.querySelector("#form-summit");
// name message
...
let validationOnGoing = false;
// all inputs
const inputs = [nameInput, emailInput, textAreaInput];
// local storage array
let fieldsArray = [
...
function resetInputs(input, message) {
    input.classList.remove('error');
    message.classList.remove('active');
}
// show errors - border and message
function invalidateInput(input, messageText, message) {
    // add visibility
